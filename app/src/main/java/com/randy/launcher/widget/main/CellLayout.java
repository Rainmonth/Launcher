...
import com.randy.launcher.InterruptibleInOutAnimator;
...
import com.randy.launcher.StylusEventHelper;
import com.randy.launcher.Utilities;
import com.randy.launcher.accessibility.DragAndDropAccessibilityDelegate;
import com.randy.launcher.accessibility.FolderAccessibilityHelper;
import com.randy.launcher.accessibility.WorkspaceAccessibilityHelper;
...
public class CellLayout extends ViewGroup implements BubbleTextView.BubbleTextShadowHandler {
    ...
    private ArrayList<FolderIcon.FolderRingAnimator> mFolderOuterRings = new ArrayList<FolderIcon.FolderRingAnimator>();
    ...
    @Thunk
    HashMap<LayoutParams, Animator> mReorderAnimators = new HashMap<>();
    @Thunk
     ...
     * @param spanX         Horizontal span of the object.
     * @param spanY         Horizontal span of the object.
     ...
     * @param result        Array in which to place the result, or null (in which case a new array will
     *                      be allocated)
     * @return he X, Y cell of a vacant area that can contain this object, nearest the requested
     * location.
     */
