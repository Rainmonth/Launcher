...
package com.randy.launcher.widget.main;
...
import com.randy.launcher.HolographicOutlineHelper;
import com.randy.launcher.HotseatIconKeyEventListener;
import com.randy.launcher.IconCache;
import com.randy.launcher.IconKeyEventListener;
import com.randy.launcher.InstallShortcutReceiver;
...
import com.randy.launcher.LauncherAppWidgetHostView;
...
import com.randy.launcher.PendingAppWidgetHostView;
import com.randy.launcher.PreloadIconDrawable;
...
import com.randy.launcher.SpringLoadedDragController;
import com.randy.launcher.Stats;
import com.randy.launcher.Utilities;
import com.randy.launcher.WorkspaceStateTransitionAnimation;
...
import com.randy.launcher.accessibility.OverviewScreenAccessibilityDelegate;
...
import com.randy.launcher.widget.PendingAddShortcutInfo;
...
public class Workspace extends PagedView
        ...
        Insettable, UninstallDropTarget.UninstallSource, AccessibilityDragSource, Stats.LaunchSourceProvider {
    ...
    @Thunk
    boolean mAddNewPageOnDrag = true;
    ...
    @Thunk
    float mLastSetWallpaperOffsetSteps = 0;
     ...
     */
    public static Rect getCellLayoutMetrics(Launcher launcher, int orientation) {
        LauncherAppState app = LauncherAppState.getInstance();
    ...
    public void removeItemsByPackageName(final ArrayList<String> packages, final UserHandleCompat user) {
        final HashSet<String> packageNames = new HashSet<String>();
        packageNames.addAll(packages);
    ...
    public void moveToCustomContentScreen(boolean animate) {
        if (hasCustomContent()) {
