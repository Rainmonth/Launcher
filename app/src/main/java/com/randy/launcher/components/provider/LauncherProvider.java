...
package com.randy.launcher.components.provider;
...
import com.randy.launcher.util.parser.AutoInstallsLayout;
import com.randy.launcher.util.parser.DefaultLayoutParser;
...
public class LauncherProvider extends ContentProvider {
    ...
    public static final String TABLE_WORKSPACE_SCREENS = LauncherSettings.WorkspaceScreens.TABLE_NAME;
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper implements AutoInstallsLayout.LayoutParserCallback {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            switch (oldVersion) {
                ...
                case 16: {
                    ...
                    LauncherClings.synchronouslyMarkFirstRunClingDismissed(mContext);
                }
                case 17: {
                    // No-op
                }
        ...
        private boolean addProfileColumn(SQLiteDatabase db) {
            ...
            long userSerialNumber = userManager.getSerialNumberForUser(
                    UserHandleCompat.myUserHandle());
            return addIntegerColumn(db, LauncherSettings.Favorites.PROFILE_ID, userSerialNumber);
        }
